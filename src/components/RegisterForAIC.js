...
const RegisterForAIC = () => {
  return (
    <section className="absolute h-[8.13%] w-[82.36%] max-sm:w-[95%] top-[81.18%] right-[8.82%] max-sm:right-[2.82%] bottom-[10.69%] left-[8.82%] max-sm:left-[2.82%] text-center text-37xl text-gray font-sora">
      <div className="absolute top-[0px] left-[0px] rounded-xl bg-lightgray box-border w-[1186px] max-sm:w-full h-[412px] border-[2px] border-solid border-gray">
        <div className="absolute top-[64px] md:left-[calc(50%_-_364px)] flex flex-col items-center justify-start max-sm:justify-center gap-[40px]">
          <div className="flex flex-col items-center justify-start max-sm:justify-center gap-[16px]">
            ...
            <div className="relative text-9xl leading-[150.02%] max-sm:leading-[32px] max-sm:text-lg max-sm:w-[90%] text-center font-medium font-inter inline-block w-[727px]">
