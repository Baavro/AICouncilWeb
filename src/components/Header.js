const Header = () => {
  return (
    <header className="absolute top-[0px] left-[calc(50%_-_722px)] bg-gainsboro w-[1440px] h-28 overflow-x-auto flex flex-col items-end justify-between py-8 px-[130px] box-border max-w-[1440px]">
