    ...
    <section className="absolute h-[14.36%] max-sm:h-[10.36%] w-[100.14%] top-[29.43%] right-[-0.07%] bottom-[56.2%] left-[-0.07%] bg-gray text-center text-37xl text-white font-sora max-sm:flex max-sm:flex-col max-sm:justify-around max-sm:items-center">
      ...
      <div className="absolute top-[260px] left-[131px] w-[1183px] h-[340px] text-left text-13xl max-sm:hidden">
        ...
        <div className="absolute top-[128px] left-[calc(50%_-_567.5px)] text-xl leading-[150.02%] font-medium font-inter inline-block w-[332px]">
          The council aims to foster a culture of innovation and exploration in
          the field of AI, driving research and development initiatives across
          the country.
        </div>
      ...
      >
        <div className="flex">
          <div className="relative min-w-[333px] rounded-xl bg-whitesmoke-200 mx-4 min-h-[250px] h-min py-2 ml-5">
            <div className="font-extrabold p-4 text-center text-[20px] leading-5">
              Promote AI research
            </div>
            <div className="text-[16px] leading-6 font-medium font-inter p-4">
          ...
          <div className="relative min-w-[333px] rounded-xl bg-whitesmoke-200 mx-4 min-h-[250px] h-min py-2">
            <div className="font-extrabold p-4 text-center text-[20px] leading-5">
              Develop AI applications
            </div>
            <div className="text-[16px] leading-6 font-medium font-inter p-4">
          ...
          <div className="relative min-w-[333px] rounded-xl bg-whitesmoke-200 mx-4 min-h-[250px] h-min py-2 mr-6">
            <div className="font-extrabold p-4 text-center text-[20px] leading-5">
              Support AI education
            </div>
            <div className="text-[16px] leading-6 font-medium font-inter p-4">
...
export default AICObjective;
{
  /**
<section className="absolute top-[calc(50%_-_1042.5px)] left-[calc(50%_-_719.5px)] bg-gray flex flex-col items-center justify-start p-32 gap-[48px] text-center text-37xl text-white font-sora bordeer">
